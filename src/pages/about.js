...
import profilePic from "../../public/images/profile/photos5.jpg";
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light ">
        <Layout className="pt-16 ">
          <AnimatedText
            ...
            className="wb-16 lg:!text-7xl sm:!text-6xl sx:!text-4xl sm:mb-8"
          />
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className=" font-medium ">
                Hi, I'm Mustafa Yılmaz, a web developer and UI/UX designer with a
            ...
            <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:border-light dark:bg-dark md:order-1 md:col-span-8">
