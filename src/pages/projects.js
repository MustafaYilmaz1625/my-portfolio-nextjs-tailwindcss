...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    <article
      className="w-full flex items-center  relative justify-center rounded-br-2xl rounded-3xl border border-solid
    ...
    >
      ...
      dark:bg-light bg-dark xs:-right-2 sm:h-[102%] xs:w-full xs:w-rounded-[1.5rem] "
      />
      ...
      <div className="w-full flex flex-col items-start justify-between mt-4">
        ...
        <div className="w-full mt-2 flex items-center justify-between">
          <Link
            href={link}
            target="_blank"
            className=" text-lg font- underline md:text-base"
          >
            Visit
          </Link>
